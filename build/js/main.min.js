...
/* harmony import */ var _modules_modal_close__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modal-close */ "./js/modules/modal-close.js");
/* harmony import */ var _modules_modal_open__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal-open */ "./js/modules/modal-open.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal_close__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_modal_open__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_contacts__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_5__["default"])();
  document.getElementById('phone-mask').addEventListener('input', _modules_phone_mask__WEBPACK_IMPORTED_MODULE_7__["default"]);
  document.getElementById('phone-mask-modal').addEventListener('input', _modules_phone_mask__WEBPACK_IMPORTED_MODULE_7__["default"]);
  ...
  window.addEventListener('load', function () {
    ...
    var unlockBtnElement = document.querySelector('.unlock');
    lockBtnElement.addEventListener('click', function () {
      return window.focusLock.lock('.lock-block');
    });
    unlockBtnElement.addEventListener('click', function () {
      return window.focusLock.unlock();
    });
    var list = document.querySelector('.footer-navigation__list');
    var items = list.querySelectorAll('.footer-navigation__item');
    var itemHeight = items[0].offsetHeight;
    var itemsPerColumn = Math.ceil(items.length / 2);
    var totalHeight = itemsPerColumn * itemHeight;
...
var contactsButton = document.querySelector('.footer-contacts__button');
var footerNavigation = document.querySelector('.footer-navigation');
var navigationList = document.querySelector('.footer-navigation__list');
...
var windowClose = function windowClose() {
  ...
  wrapper.inert = false;
  var previouslyFocusedElement = document.querySelector('.js-modal-focus');
...
var wrapper = document.querySelector('.wrapper');
var headerButton = document.querySelector('.header__button.lock');
...
var modalOpen = function modalOpen() {
  ...
  var focusableElements = modal.querySelectorAll('a[href], button:not([disabled]), textarea, input[type="text"], input[type="radio"], input[type="checkbox"], select');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var navigationButton = document.querySelector('.footer-navigation__button');
var footerNavigation = document.querySelector('.footer-navigation');
var navigationList = document.querySelector('.footer-navigation__list');
var navigationListTitle = footerNavigation.querySelector('h2');
var footerContacts = document.querySelector('.footer-contacts');
...
function phoneMask(event) {
  ...
  var phoneMatches = event.target.value.replace(/\D/g, '').match(/\+?(\d{0,1}) ?\(?(\d{0,3})\)? ?(\d{0,3})? ?(\d{0,2})? ?(\d{0,2})?/);
  var value = '+7';
